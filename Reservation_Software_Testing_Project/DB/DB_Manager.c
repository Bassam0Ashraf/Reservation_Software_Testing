...
extern struct User_Input_Type Test_ActualFormRecieved;
...
unsigned char DBM_Add_User(struct User_Input_Type* Form)
{
	...
	{
		// Test Structure is fullfield with Actual Recieved Data
		Test_ActualFormRecieved.PersonalInfo_Form.id = Current_user;
		Test_ActualFormRecieved.PersonalInfo_Form.Age = Form->PersonalInfo_Form.Age;
		strcpy(Test_ActualFormRecieved.PersonalInfo_Form.name, Form->PersonalInfo_Form.name);
		Test_ActualFormRecieved.PersonalInfo_Form.DOB_day = Form->PersonalInfo_Form.DOB_day;
		Test_ActualFormRecieved.PersonalInfo_Form.DOB_month = Form->PersonalInfo_Form.DOB_month;
		Test_ActualFormRecieved.PersonalInfo_Form.DOB_year = Form->PersonalInfo_Form.DOB_year;
		Test_ActualFormRecieved.PersonalInfo_Form.educational_status = Form->PersonalInfo_Form.educational_status;
		Test_ActualFormRecieved.PersonalInfo_Form.gender = Form->PersonalInfo_Form.gender;
		strcpy(Test_ActualFormRecieved.LoginCredentials_Form.LoginCredentials.User_Name, Form->LoginCredentials_Form.LoginCredentials.User_Name);
		strcpy(Test_ActualFormRecieved.LoginCredentials_Form.LoginCredentials.Password, Form->LoginCredentials_Form.LoginCredentials.Password);
		// Test Code Finished 
...
/* Testing function DBM_ShowCourse */
unsigned char Test_DBM_ShowCourse(int User_Id)
{
	unsigned char RET = FALSE;
	unsigned int course_id;
	for (course_id = 0; course_id < MAX_COURSES; course_id++)
